...
- Removed unused generators (PHP, Lua, Python, Dart) as Rarry doesn't use them.
- Individual block padding: Left and right padding can be different from eachother.
