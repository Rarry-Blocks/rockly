...
/** Allow a number, or left and right object. Used in SHAPE_IN_SHAPE_PADDING. */
export type Padding = number | {left: number; right: number};
...
export class RenderInfo extends BaseRenderInfo {
  ...
  protected getNegativeSpacing_(
    ...
    const resolvePadding = (pad: Padding | undefined): number => {
